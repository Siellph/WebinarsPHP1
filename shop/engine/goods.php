...
if (mysqli_num_rows($result) > 0) {
    while($good = mysqli_fetch_assoc($result)) {
        ...
        echo '<a id="'.$id.'" href="goodcard.php?id='.$id.'" class="more_title" target="_blank"><p class="title">'.$good_title.'</p></a>';
        echo '<a id="'.$id.'" href="goodcard.php?id='.$id.'" class="more_img" target="_blank"><img class="good_img" src="'.$path_photo.$name_photo.'"></a>';
        echo '</div>';
